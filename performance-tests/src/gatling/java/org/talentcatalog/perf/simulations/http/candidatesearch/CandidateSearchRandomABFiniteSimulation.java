 ...
 *   <li>Choose NEW vs OLD based on {@code randPctNew} (0..100)</li>
 *   <li>Execute the chosen candidate search request</li>
 * </ol>
 *
 * <p>This simulation is useful for modeling a finite burst of users with mixed traffic,
 * while keeping per-user behavior bounded (exactly {@code randRepeats} loops).</p>
 *
 ...
 * }</pre>
 */
public class CandidateSearchRandomABFiniteSimulation extends CandidateSearchBaseSimulation {
  ...
  /**
   * Percent of iterations routed to the NEW endpoint (0..100). Default: 50.
   */
   ...
   */
  public CandidateSearchRandomABFiniteSimulation() {
    if (RAND_USERS <= 0) {
