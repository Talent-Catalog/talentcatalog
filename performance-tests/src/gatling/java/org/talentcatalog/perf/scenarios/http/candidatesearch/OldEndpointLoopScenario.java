 ...
 *   <li>Repeats {@code repeats} candidate-search requests against the <b>old-fetch</b> endpoint</li>
 ...
 */
public final class OldEndpointLoopScenario {
   ...
   */
  private OldEndpointLoopScenario() {
  }

  /**
   * Creates the "old-fetch endpoint" candidate search loop scenario.
   *
   * @param payloadPath     path to the JSON payload resource (e.g.,
   *                        {@code "payloads/candidate_search_heavy.json"})
