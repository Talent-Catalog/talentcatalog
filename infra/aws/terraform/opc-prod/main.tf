...
module "tc-plus-prod" {
  ...
  es_url                                 = ""  # todo: retire elasticsearch
  es_username                            = ""  # todo: retire elasticsearch
  ...
  sf_base_classic_url                    = ""  # todo: either create for OPC or decouple TC+ from SF
  sf_base_lightning_url                  = ""  # todo: either create for OPC or decouple TC+ from SF
  sf_base_login_url                      = ""  # todo: either create for OPC or decouple TC+ from SF
  ...
  tc_api_url                             = ""  # todo: set TC API URL
  tc_cors_urls                           = ""  # todo: set prod CORS URLs
  tc_db_copy_config                      = "data.sharing/tcCopies.xml" # todo: can this be retired?
  tc_destinations                        = ""  # todo: set TC destinations
