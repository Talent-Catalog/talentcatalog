...
class CandidateLanguageAdminApiTest extends ApiTestBase {
  ...
  private static final CandidateLanguage candidateLanguage =
      AdminApiTestUtil.getCandidateLanguage();

  private static final List<CandidateLanguage> candidateLanguageList =
      AdminApiTestUtil.getListOfCandidateLanguages();
  ...
  void getCandidateLanguagesSucceeds() throws Exception {
    ...
    given(candidateLanguageService.list(anyLong())).willReturn(candidateLanguageList);

    mockMvc
        .perform(
            get(BASE_PATH + GET_LIST_PATH.replace("{id}", String.valueOf(CANDIDATE_ID)))
  ...
  void createCandidateLanguageSucceeds() throws Exception {
    ...
    given(
            candidateLanguageService.createCandidateLanguage(
                any(CreateCandidateLanguageRequest.class)))
    ...
    verify(candidateLanguageService)
  ...
  void updateCandidateLanguageSucceeds() throws Exception {
    ...
    given(
            candidateLanguageService.updateCandidateLanguage(
                any(UpdateCandidateLanguageRequest.class)))
        .willReturn(candidateLanguage);
