...
import org.tctalent.server.data.SavedSearchTestData;
...
//                    Role.user);
    ...
    public static User getUserMinimal() {
        return caller;
    }
...
//    public static PartnerImpl getPartnerImpl() {
...
//    }
  ...
  public static List<SavedSearch> getListOfSavedSearches() {
      SavedSearch savedSearch1 = SavedSearchTestData.getSavedSearch();
      SavedSearch savedSearch2 = SavedSearchTestData.getSavedSearch();
      savedSearch2.setName("Saved Search 2");
      SavedSearch savedSearch3 = SavedSearchTestData.getSavedSearch();
