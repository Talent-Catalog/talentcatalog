...
class CandidateReviewStatusAdminApiTest extends ApiTestBase {
  ...
  void createCandidateReviewStatusSucceeds() throws Exception {
    ...
    verify(candidateReviewStatusService).createCandidateReviewStatusItem(
        any(CreateCandidateReviewStatusRequest.class));
  }
  ...
  void updateCandidateReviewStatusByIdSucceeds() throws Exception {
    ...
    verify(candidateReviewStatusService).updateCandidateReviewStatusItem(anyLong(),
        any(UpdateCandidateReviewStatusRequest.class));
  }
