...
insert into task (name, display_name, task_type, description, days_to_complete, created_by,
                  created_date)
values ('italyTrainToHireTravelDocUpload', 'Travel Document Upload', 'Upload', 'placeholder',
        7, (select id from users where username = 'SystemAdmin'), now());

-- Relocating candidate dependant travel doc upload
insert into task (name, display_name, task_type, description, days_to_complete, created_by,
                  created_date)
values ('italyTrainToHireDependantTravelDocUpload', 'Dependant Travel Document Upload', 'Upload',
...
insert into task (name, display_name, task_type, description, days_to_complete, created_by,
                  created_date)
values ('italyTrainToHireRefugeeStatusDocUpload', 'Refugee Status Document Upload', 'Upload',
        'placeholder', 7, (select id from users where username = 'SystemAdmin'), now());
...
values ('italyTrainToHireDependantRefugeeStatusDocUpload', 'Dependant Refugee Status Document Upload',
        'Upload', 'placeholder', 7, (select id from users where username = 'SystemAdmin'), now());