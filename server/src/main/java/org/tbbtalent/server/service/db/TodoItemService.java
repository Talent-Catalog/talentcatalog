...
public interface TodoItemService {
    List<TodoItem> listTodoItems(Long candidateId);

    TodoItem createTodoItem(CreateCandidateTodoRequest request);

    TodoItem updateTodoItem(UpdateCandidateTodoRequest request);
