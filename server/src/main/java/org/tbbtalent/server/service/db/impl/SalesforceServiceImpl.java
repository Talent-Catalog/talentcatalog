...
public class SalesforceServiceImpl implements SalesforceService, InitializingBean {
    ...
    private final String commonOpportunityFields =
        "Id,Name,AccountId,Closing_Comments__c,NextStep,Next_Step_Due_Date__c,StageName,IsClosed,AccountCountry__c,IsWon";
    ...
    private final String jobOpportunityRetrievalFields =
        commonOpportunityFields +
        ",RecordTypeId,OwnerId,Hiring_Commitment__c,AccountName__c,Account.Description,AccountWebsite__c,AccountHasHiredInternationally__c,Opportunity_Score__c";
