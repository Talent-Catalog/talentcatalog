...
public class S3ResourceHelper {
  ...
  public List<S3ObjectSummary> getObjectSummaries() {
    ObjectListing objects = amazonS3.listObjects
        (s3Bucket, "candidate/");
    List<S3ObjectSummary> objectSummaries = new ArrayList<S3ObjectSummary>(objects.getObjectSummaries());
  ...
  public void addObjectMetadata(S3ObjectSummary objectSummary) {
    ...
    final CopyObjectRequest request = new CopyObjectRequest(objectSummary.getBucketName(), objectSummary.getKey(),
