 ...
 */
@Mapper
public abstract class SurveyTypeMapper {

    @Autowired
    protected SurveyTypeService service;

    public SurveyType lookUpFromService(
        org.tctalent.anonymization.model.SurveyType publicValue) {
        return publicValue == null ? null : service.findByName(publicValue.getName());
    }
}
