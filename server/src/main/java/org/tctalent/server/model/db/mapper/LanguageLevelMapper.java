 ...
 */
@Mapper
public abstract class LanguageLevelMapper {

    @Autowired
    protected LanguageLevelService service;

    public LanguageLevel lookUpFromService(
        org.tctalent.anonymization.model.LanguageLevel publicValue) {
