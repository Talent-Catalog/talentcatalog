 ...
 */
@Mapper
public abstract class EducationMajorMapper {

    @Autowired
    protected EducationMajorService service;

    public EducationMajor lookUpFromService(
        org.tctalent.anonymization.model.EducationMajor publicValue) {
        return publicValue == null || publicValue.getId() == null ? null
            : service.getEducationMajor(publicValue.getId());
    }
}
