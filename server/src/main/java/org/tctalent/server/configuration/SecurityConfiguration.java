 ...
 * <ul>
 * <li>
 * We manage our own users and passwords, stored in the users table of the
 * database
 * </li>
 * <li>
 * At login we issue JSON Web Tokens (JWTs) which appear on each HTTP request in
 * the
 * Authorization header as a Bearer token.
 * See <a href=
 * "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Authorization">...</a>
 * and
 ...
 * </li>
 * <li>
 * {@link JwtAuthenticationFilter} is a filter which checks incoming JWT tokens,
 * validating
 * them.
 * </li>
 * <li>
 * {@link TcUserDetailsService} implements UserDetailsService providing access
 * to the user
 * table in our database
 * </li>
 * <li>
 * {@link TcAuthenticationProvider} implements AuthenticationProvider passing in
 * our
 * wired in instance of the above TcUserDetailsService, and the PasswordEncoder
 * defined
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .authorizeHttpRequests((authz) -> authz
            ...
            // SEE CANDIDATE FILE ATTACHMENTS. ADMIN/SOURCE PARTNER ADMIN ALLOWED. READ ONLY
            // has access BUT has the data restricted in the DTO based on role.
