...
anonymised data and functionality. The API was envisioned by **TBB's Global Leadership Team** in 
Canada, October 2023, as a key component for enabling interoperability between Talent Catalog and 
