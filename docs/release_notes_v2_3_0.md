...
- Employer partners are restricted from selecting global lists when adding candidates to a list through the 'save/copy selection' pop up
- Admin user's can only replace candidates in a list if they own the list through the 'save/copy selection' pop up
