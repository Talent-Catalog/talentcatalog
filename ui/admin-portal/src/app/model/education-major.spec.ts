...
describe('EducationMajor interface', () => {
  it('should create an EducationMajor instance', () => {
    ...
    expect(educationMajor).toBeTruthy();
    expect(educationMajor.id).toBe(1);
    expect(educationMajor.name).toBe('Computer Science');
    expect(educationMajor.status).toBe('Active');
  });
});
