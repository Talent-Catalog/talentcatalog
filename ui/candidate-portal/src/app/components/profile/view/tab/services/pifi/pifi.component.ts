...
/**
 * Component for displaying and managing the PiFi signposting link service.
 */
@Component({
  selector: 'app-pifi',
  templateUrl: './pifi.component.html',
  styleUrl: './pifi.component.scss'
})
export class PifiComponent implements OnInit {
  ...
  private readonly provider = 'PIFI';
  ...
  get countryName(): string {
    return this.candidate?.country?.name || 'your destination';
  }
